...
typedef void (*HUD_CLIENTMOVE_FUNC)(struct playermove_s* ppmove, bool server);
...
typedef void (*HUD_VOICESTATUS_FUNC)(int entindex, bool bTalking);
...
typedef bool (*pfnEngSrc_GetPlayerUniqueID_t)(int iPlayer, char playerID[16]);
...
typedef void (*pfnEngSrc_SetMouseEnable_t)(bool fEnable);
